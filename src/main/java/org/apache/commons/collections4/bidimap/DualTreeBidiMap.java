...
public class DualTreeBidiMap<K extends Comparable<K>, V extends Comparable<V>>
    ...
    private DualTreeBidiMap<V, K> inverseBidiMap;
    ...
    protected DualTreeBidiMap(final TreeMap<K, V> keyMap, final TreeMap<V, K> valueMap) {
    ...
    protected DualTreeBidiMap(final TreeMap<K, V> keyMap, final TreeMap<V, K> reverseMap, final DualTreeBidiMap<V, K> inverseBidiMap) {
    ...
    private DualTreeBidiMap<V, K> createInverse() {
        return new DualTreeBidiMap<>(valueMap, keyMap, this);
    }
