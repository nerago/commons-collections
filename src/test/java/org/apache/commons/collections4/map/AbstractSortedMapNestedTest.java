 ...
 */
public abstract class AbstractSortedMapNestedTest<K, V> extends AbstractSortedMapTest<K, V> {
    protected abstract AbstractMapTest<K, V> getEnclosing();

    @Override
    public SortedMap<K, V> makeObject() {
        return (SortedMap<K, V>) getEnclosing().makeObject();
    }

    @Override
    public SortedMap<K, V> makeFullMap() {
        return (SortedMap<K, V>) getEnclosing().makeFullMap();
    }

    @Override
    public SortedMap<K, V> makeConfirmedMap() {
        return (SortedMap<K, V>) getEnclosing().makeConfirmedMap();
    }
